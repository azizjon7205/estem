...
import 'package:estem/shared/models/questions/question_dropdown.dart';
...
class _FormDropdownState extends State<FormDropdown> {
  ...
  void onSwitchValueChanged(bool value) {
    ...
    setState(() {
      isRequired = value;
      query = query.copyWith(isRequired: value) as DropdownQuestion;
    });
  }
  ...
  void onPickImage() async {
    ...
    try {
      ...
      setState(() {
        query = query.copyWith(image: base64Image) as DropdownQuestion;
  ...
  @override
  void didUpdateWidget(covariant FormDropdown oldWidget) {
      ...
      child: Column(
        ...
        children: [
          AppTextField(
            ...
            onChanged: (value) {
              query = query.copyWith(question: value) as DropdownQuestion;
              widget.onQuestionChanged(query);
            },
          ),
          if (_imageBytes != null) ...[
